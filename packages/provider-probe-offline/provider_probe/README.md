...
> 更新：2026-06-16（CP-5 迁入 `packages/provider-probe-offline/`）
> 层级：**Cold**（离线实验流水线）
> 包索引：[`../../packages/provider-probe-offline/README.md`](../../packages/provider-probe-offline/README.md)
...
| **本包** | Cold | 不得被 `server.py` / 路由注册默认挂载 |
