...
var panelLoaders={overview:loadStats,traffic:loadLogs,backends:loadBackends,retrieval:loadRetrieval,model:function(){return Promise.all([loadModel(),loadFallbackAnalysis()])},health:loadHealth,keys:loadKeyUrl,agents:loadAgents,'agent-tasks':loadAgentTasks,config:loadConfig,devices:loadDevices,alerts:loadAlerts,'live-logs':function(){return Promise.resolve()}};
