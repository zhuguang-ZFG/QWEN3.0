...
BACKENDS = {
    ...
    'deepseek_free': {'url': 'http://127.0.0.1:8000/v1/chat/completions', 'key': 'none', 'model': 'deepseek-default', 'fmt': 'openai', 'timeout': 60, 'caps': ['tool_calls'], 'admission': 'code_medium_candidate', 'private_code_allowed': True},
