...
def recall_planner_hints(store: MemoryStore, device_id: str) -> dict[str, Any]:
...
def get_preferred_feed_for_device(store: MemoryStore, device_id: str) -> float | None:
...
def get_device_failure_warnings(store: MemoryStore, device_id: str) -> list[dict[str, Any]]:
