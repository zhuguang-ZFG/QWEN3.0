...
BACKENDS = {
    ...
    'unclose_qwen': {'url': 'https://qwen.ai.unturf.com/v1/chat/completions', 'key': 'none', 'model': 'Qwen3.6-27B-UD-Q4_K_XL.gguf', 'fmt': 'openai', 'timeout': 30},
    ...
    'github_gpt4o': {'url': 'https://models.inference.ai.azure.com/chat/completions', 'key': os.environ.get('GITHUB_TOKEN', ''), 'model': 'gpt-4o', 'fmt': 'openai', 'timeout': 15},
    'github_gpt4o_mini': {'url': 'https://models.inference.ai.azure.com/chat/completions', 'key': os.environ.get('GITHUB_TOKEN', ''), 'model': 'gpt-4o-mini', 'fmt': 'openai', 'timeout': 15},
    ...
    'google_gemini3': {'url': 'https://generativelanguage.googleapis.com/v1beta/openai/chat/completions', 'key': os.environ.get('GOOGLE_AI_KEY', ''), 'model': 'gemini-3-flash', 'fmt': 'openai', 'timeout': 20},
    'google_gemma4': {'url': 'https://generativelanguage.googleapis.com/v1beta/openai/chat/completions', 'key': os.environ.get('GOOGLE_AI_KEY', ''), 'model': 'gemma-3-27b-it', 'fmt': 'openai', 'timeout': 15},
...
def detect_vendor(url: str) -> str:
    u = url.lower()
    if 'longcat' in u: return 'LongCat'
    if 'nvidia' in u: return 'NVIDIA'
    ...
    if 'baidubce.com' in u: return 'Baidu'
    if 'volces.com' in u: return 'Volcengine'
    if 'aliyuncs.com' in u: return 'Alibaba'
    if 'tencent' in u or 'hunyuan' in u: return 'Tencent'
    if 'unturf.com' in u: return 'UncloseAI'
