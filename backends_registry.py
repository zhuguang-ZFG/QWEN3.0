...
BACKENDS = {
    ...
    'groq_gptoss': {'url': 'https://api.groq.com/openai/v1/chat/completions', 'key': os.environ.get('GROQ_API_KEY', ''), 'model': 'openai/gpt-oss-120b', 'fmt': 'openai', 'timeout': 15},
    ...
    'groq_qwen32b': {'url': 'https://api.groq.com/openai/v1/chat/completions', 'key': os.environ.get('GROQ_API_KEY', ''), 'model': 'qwen/qwen3-32b', 'fmt': 'openai', 'timeout': 15},
    'groq_llama4': {'url': 'https://api.groq.com/openai/v1/chat/completions', 'key': os.environ.get('GROQ_API_KEY', ''), 'model': 'meta-llama/llama-4-scout-17b-16e-instruct', 'fmt': 'openai', 'timeout': 15},
    ...
    'cerebras_qwen235b': {'url': 'https://api.cerebras.ai/v1/chat/completions', 'key': os.environ.get('CEREBRAS_API_KEY', ''), 'model': 'qwen-3-235b-a22b-instruct-2507', 'fmt': 'openai', 'timeout': 30},
    ...
    'google_flash_lite': {'url': 'https://generativelanguage.googleapis.com/v1beta/openai/chat/completions', 'key': os.environ.get('GOOGLE_AI_KEY', ''), 'model': 'gemini-3.1-flash-lite', 'fmt': 'openai', 'timeout': 15},
...
DISABLED_HOST_DEPENDENT_BACKENDS = {
    ...
    for name in (
        ...
        # M3: kimi now VPS kimi-proxy.service, no longer needs pop
