...
BACKENDS = {
    ...
    'longcat_web': {'url': 'http://localhost:4506/v1/chat/completions', 'key': 'local', 'model': 'longcat-web', 'fmt': 'openai', 'timeout': 60, 'force_stream_param': False, 'admission': 'code_floor_candidate', 'private_code_allowed': True},
    'longcat_web_think': {'url': 'http://localhost:4506/v1/chat/completions', 'key': 'local', 'model': 'longcat-web-think', 'fmt': 'openai', 'timeout': 120, 'force_stream_param': False},
    'longcat_web_research': {'url': 'http://localhost:4506/v1/chat/completions', 'key': 'local', 'model': 'longcat-web-research', 'fmt': 'openai', 'timeout': 180, 'force_stream_param': False},
    ...
    'groq_gptoss': {'url': 'https://api.groq.com/openai/v1/chat/completions', 'key': os.environ.get('GROQ_API_KEY', ''), 'model': 'llama-3.3-70b-versatile', 'fmt': 'openai', 'timeout': 15},
    'groq_gptoss_20b': {'url': 'https://api.groq.com/openai/v1/chat/completions', 'key': os.environ.get('GROQ_API_KEY', ''), 'model': 'llama-3.1-8b-instant', 'fmt': 'openai', 'timeout': 10},
    ...
    'aliyun_qwen3': {'url': 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions', 'key': os.environ.get('ALIYUN_API_KEY', ''), 'model': 'qwen3-8b', 'fmt': 'openai', 'timeout': 10, 'force_stream_param': False},
    ...
    # ── 讯飞星火编码模型 (逆向网页) ──
    'xfyun_astron': {'url': 'https://maas-coding-api.cn-huabei-1.xf-yun.com/v2/chat/completions', 'key': os.environ.get('XFYUN_API_KEY', ''), 'model': 'astron-code-latest', 'fmt': 'openai', 'timeout': 30, 'auth': 'bearer', 'caps': ['tool_calls'], 'admission': 'code_medium_candidate', 'private_code_allowed': True},
    ...
    'mimo_web': {'url': f"http://{os.environ.get('VPS_HOST', '47.112.162.80')}:4507/v1/chat/completions", 'key': 'none', 'model': 'mimo-web', 'fmt': 'openai', 'timeout': 60, 'force_stream_param': False, 'admission': 'sandbox_only', 'private_code_allowed': False, 'caps': ['tool_calls']},
    'mimo_web_think': {'url': f"http://{os.environ.get('VPS_HOST', '47.112.162.80')}:4507/v1/chat/completions", 'key': 'none', 'model': 'mimo-web-think', 'fmt': 'openai', 'timeout': 120, 'force_stream_param': False, 'admission': 'sandbox_only', 'private_code_allowed': False, 'caps': ['tool_calls']},
    'mimo_web_flash': {'url': f"http://{os.environ.get('VPS_HOST', '47.112.162.80')}:4507/v1/chat/completions", 'key': 'none', 'model': 'mimo-web-flash', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'admission': 'sandbox_only', 'private_code_allowed': False, 'caps': ['tool_calls']},
    # ── MiMo TTS (官方API, 限时免费) ──
    ...
    'mimo_v2_pro': {'url': 'https://token-plan-cn.xiaomimimo.com/v1/chat/completions', 'key': os.environ.get('MIMO_V2_PRO_KEY', ''), 'model': 'mimo-v2-pro', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    'mimo_v2_5_pro': {'url': 'https://token-plan-cn.xiaomimimo.com/v1/chat/completions', 'key': os.environ.get('MIMO_V2_PRO_KEY', ''), 'model': 'mimo-v2.5-pro', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    'mimo_v2_5': {'url': 'https://token-plan-cn.xiaomimimo.com/v1/chat/completions', 'key': os.environ.get('MIMO_V2_PRO_KEY', ''), 'model': 'mimo-v2.5', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    'mimo_v2_omni': {'url': 'https://token-plan-cn.xiaomimimo.com/v1/chat/completions', 'key': os.environ.get('MIMO_V2_PRO_KEY', ''), 'model': 'mimo-v2-omni', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    ...
    'scnet_large_ds_flash': {'url': f"http://{os.environ.get('VPS_HOST', '127.0.0.1')}:4508/v1/chat/completions", 'key': 'none', 'model': 'deepseek-v4-flash', 'fmt': 'openai', 'timeout': 60, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'scnet_large_ds_pro': {'url': f"http://{os.environ.get('VPS_HOST', '127.0.0.1')}:4508/v1/chat/completions", 'key': 'none', 'model': 'deepseek-v4-pro', 'fmt': 'openai', 'timeout': 90, 'caps': ['tool_calls']},
    # ── ModelScope 免费 API (ms-key, 流式推荐) ──
    'ms_deepseek_v4': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'deepseek-ai/DeepSeek-V4-Flash', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    'ms_qwen35_27b': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'Qwen/Qwen3.5-27B', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    'ms_kimi_k25': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'moonshotai/Kimi-K2.5', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    'ms_glm5': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'ZhipuAI/GLM-5', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'caps': ['tool_calls']},
    # ── 编程后端池 (admission=code_* 被编程场景路由选中) ──
    'ms_qwen35_27b_code': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'Qwen/Qwen3.5-27B', 'fmt': 'openai', 'timeout': 45, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'ms_kimi_k25_code': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'moonshotai/Kimi-K2.5', 'fmt': 'openai', 'timeout': 45, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'ms_deepseek_v4_code': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'deepseek-ai/DeepSeek-V4-Flash', 'fmt': 'openai', 'timeout': 30, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'ms_glm5_code': {'url': 'https://api-inference.modelscope.cn/v1/chat/completions', 'key': os.environ.get('MODELSCOPE_API_KEY', ''), 'model': 'ZhipuAI/GLM-5', 'fmt': 'openai', 'timeout': 45, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    ...
    'aliyun_qwen3_code': {'url': 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions', 'key': os.environ.get('ALIYUN_API_KEY', ''), 'model': 'qwen3-8b', 'fmt': 'openai', 'timeout': 20, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True},
    ...
    'scnet_qwen235b_code': {'url': f"http://{os.environ.get('VPS_HOST', '127.0.0.1')}:4508/v1/chat/completions", 'key': 'none', 'model': 'qwen3-235b', 'fmt': 'openai', 'timeout': 60, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'scnet_ds_pro_code': {'url': f"http://{os.environ.get('VPS_HOST', '127.0.0.1')}:4508/v1/chat/completions", 'key': 'none', 'model': 'deepseek-v4-pro', 'fmt': 'openai', 'timeout': 90, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    ...
    'mimo_web_code': {'url': f"http://{os.environ.get('VPS_HOST', '47.112.162.80')}:4507/v1/chat/completions", 'key': 'none', 'model': 'mimo-web', 'fmt': 'openai', 'timeout': 60, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'mimo_web_think_code': {'url': f"http://{os.environ.get('VPS_HOST', '47.112.162.80')}:4507/v1/chat/completions", 'key': 'none', 'model': 'mimo-web-think', 'fmt': 'openai', 'timeout': 120, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    # ── MiMo v2.x 编程池 (Token Plan, 38B tokens) ──
    'mimo_v2_5_pro_code': {'url': 'https://token-plan-cn.xiaomimimo.com/v1/chat/completions', 'key': os.environ.get('MIMO_V2_PRO_KEY', ''), 'model': 'mimo-v2.5-pro', 'fmt': 'openai', 'timeout': 45, 'force_stream_param': False, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
