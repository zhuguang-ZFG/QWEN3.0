...
BACKENDS = {
    ...
    'dashscope_coding': {'url': 'https://coding.dashscope.aliyuncs.com/v1/chat/completions', 'key': 'sk-sp-1540fa0eb3b547d99e32087081d3ba3b', 'model': 'qwen3-coder-plus', 'fmt': 'openai', 'timeout': 30, 'admission': 'code_medium_candidate', 'private_code_allowed': True, 'caps': ['tool_calls']},
    'dashscope_coding_anthropic': {'url': 'https://coding.dashscope.aliyuncs.com/apps/anthropic/v1/messages', 'key': 'sk-sp-1540fa0eb3b547d99e32087081d3ba3b', 'model': 'qwen3-coder-plus', 'fmt': 'anthropic', 'auth': 'bearer', 'timeout': 30, 'admission': 'code_medium_candidate', 'private_code_allowed': True},
