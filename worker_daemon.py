...
STOP_FILE = Path(os.environ.get("LIMA_STOP_FILE", ".lima-worker/dev/worker.stop.json"))
AUDIT_FILE = Path(os.environ.get("LIMA_AUDIT_FILE", ".lima-worker/dev/audit.jsonl"))
