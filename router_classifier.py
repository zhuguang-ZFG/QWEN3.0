"""Rule and signal classifiers extracted from smart_router (CQ-014 slice 6)."""
...
def _context_signals(query: str, system_prompt: str = "", ide: str = "unknown"):
    q = query[:800]
...
def _enhanced_classify(query: str, system_prompt: str = "", ide: str = "unknown"):
...
def analyze(query: str, system_prompt: str = "", ide: str = "unknown", mode: str = "fast"):
