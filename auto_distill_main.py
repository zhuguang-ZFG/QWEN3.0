#!/usr/bin/env python3
"""auto_distill_main.py — red V1flash 自动蒸馏+持续训练系统主控守护进程
...
def run_filter_phase(state: dict) -> dict:
    ...
    try:
        ...
        _log.debug("auto_distill_main.py: {}", type(exc).__name__)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="red V1flash 自动蒸馏守护进程",
