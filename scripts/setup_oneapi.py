...
channels = [
    ...
    ("baidu", 1, "bce-v3/ALTAK-TBS1FqErvp8KrI5QtegFL/6cb341ad50b09a475e384437a6d848facc11c649",
    ...
    ("mistral", 1, "MISTRAL_KEY_PLACEHOLDER",
    ...
    ("mistral-codestral", 1, "MISTRAL_KEY_PLACEHOLDER",
     "https://codestral.mistral.ai/v1",
     "codestral-latest",
     "code", 90),
    ("nvidia", 1, "NVIDIA_KEY_PLACEHOLDER",
    ...
    ("longcat", 1, "LONGCAT_KEY_PLACEHOLDER",
    ...
    ("deepseek", 1, "DEEPSEEK_KEY_PLACEHOLDER",
     "https://api.deepseek.com/v1",
     "deepseek-v4-pro,deepseek-v4-flash",
     "thinking,code", 70),
    ("chinamobile", 1, "CHINAMOBILE_KEY_PLACEHOLDER",
     "https://maas.gd.chinamobile.com:36007/ai/uifm/open/v1",
     "minimax-m25",
     "general", 75),
    ("cloudflare", 1, "CLOUDFLARE_KEY_PLACEHOLDER",
