...
| Code quality (P0/P1) | P0 done; P1.3 in progress | Body limit middleware, live-key metadata-only, key_rotation archive, semantic_cache warnings, admin constant-time login; P1.3 batch2 完成 streaming/audit/device intent — `docs/CODE_QUALITY_IMPROVEMENT_PLAN_2026-05-25.md`. |
