...
> 鏍圭洰褰?`STATUS.md` 涓?[`docs/PROJECT_STATUS_CN.md`](docs/PROJECT_STATUS_CN.md) 淇濇寔鍚屾銆?
---
...
| **璁惧鎶曢€?M1+M2** | 鉁?| WSS ticket+hello+drain+鍦ㄧ嚎 push锛沗delivery_reaper` 鍍靛案浼氳瘽/stale processing锛涚绾?`queued_no_delivery` |
| **宸ヤ綔鍖?profile** | 鉁?| `resolve_workspace_mm`锛歟xplicit 鈫?complete锛坄profile_id`+姝ｆ湁闄?workspace / device registry / KNOWN锛夆啋 product 300 鈫?DEFAULT锛涢潪娉?workspace 蹇界暐锛沚are registry/shadow 淇濇寔 incomplete |
| 涓绘爲澶?Agent 闅旂瑙勫垯 | 鉁?| `AGENTS.md` 纭鍒欙紱涓€ Agent 涓€ worktree |
...
| P0-4 | 寰俊瀹℃牳鍙戝竷锛堜粨搴撶増鏈?3.9.2锛涜 `docs/WECHAT_REVIEW_CHECKLIST_CN.md`锛?| 杩愯惀/鎻愬 |
...
璇﹁ [`docs/superpowers/specs/2026-07-02-backlog-planning.md`](docs/superpowers/specs/2026-07-02-backlog-planning.md)銆?
---
...
- 璁惧 WSS ticket锛氳 `device_ws_ticket.py` / `docs/DEVICE_WS_TOKEN_DEPRECATION_CN.md`
...
- 鎶ュ憡锛歚fz/results/agent_gate_last.json`
...
| 鏂囨。 | 鐢ㄩ€?|
|------|------|
| [`AGENTS.md`](AGENTS.md) | Cursor / Agent 鍏ュ彛 |
| [`docs/AGENTS_REFERENCE_CN.md`](docs/AGENTS_REFERENCE_CN.md) | 瀹屾暣瑙勮寖 |
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | 鏋舵瀯 |
| [`docs/README.md`](docs/README.md) | 鏂囨。绱㈠紩 |
| [`docs-site/api/voice.md`](docs-site/api/voice.md) | 璇煶 API |
| [`docs/DEVICE_DEVELOPER_GUIDE_CN.md`](docs/DEVICE_DEVELOPER_GUIDE_CN.md) | 璁惧鑱旇皟鍏ュ彛 |
| [`docs/DEPLOY_AND_RELEASE_CONVENTION.md`](docs/DEPLOY_AND_RELEASE_CONVENTION.md) | 閮ㄧ讲绾﹀畾 |
