...
| External capability radar | Ledger active | `docs/REFERENCE_IMPLEMENTATION_LEDGER.md` records 63 reference mappings with implemented/gated/concept/evaluating/rejected status; unimplemented capabilities remain behind license, security, privacy, and safety gates. |
