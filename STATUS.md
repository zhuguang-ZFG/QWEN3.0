...
| External capability radar | Expanded | Added 16 new references across search, governance, agent skills, browser automation, code graphs, OCR/TTS, robotics, and world-model research; all are concept/reference inputs until license, security, privacy, and safety gates pass. |
