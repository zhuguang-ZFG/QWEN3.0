...
| **工作区 profile** | ✅ 路径生成/预检 `resolve_workspace_mm`：完整 profile → product 300×300×80 → DEFAULT；内置 `writing-machine-300`；dlc_api/draw/handwriting 传 `device_id`。 | 设备 shadow 登记真实 workspace |
