...
| AUDIT-8 | 性能 | P3 缓存 WAL + P2 intent 去重 + P4 httpx 连接池复用 + P9 退役热路径清理 | P3/P2/P4/P9 关闭（P1/P5/P6/P7 延后） |
...
- **延后项（核心路径改造，需专门性能/集成测试）**：P1（instructor 同步 LLM 异步化）、P5（embedding 异步化+LRU）、P6/P7（共享状态+多 worker）；P8（投机执行优化）
- 状态：**AUDIT-8 P2/P3/P4/P9 已关闭**；P1/P5/P6/P7/P8 延后。
