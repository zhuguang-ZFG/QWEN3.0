...
| CQ-082 | Closed | Repo hygiene: `test_repo_hygiene.py`, `scripts/archive/`, deepcode-cli `data/` ignore, untrack unused `router_ml_model.pkl`, `scripts/README.md`. | Bump deepcode-cli submodule pointer when submodule repo commits `.gitignore`. |
