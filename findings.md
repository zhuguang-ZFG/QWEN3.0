...
| CQ-083 | Closed | VPS bundle deploy `deploy_vps_bundle.py`: CQ-080 security + CQ-081 P3 splits + retrieval. Smokes `prod_retrieval_trace_ok`, `ctx003_messages_ok`. Tests **1470 passed**. | Automate backup retention in deploy script. |
