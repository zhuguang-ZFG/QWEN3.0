...
| CQ-080 | Closed | Review fixes: ASGI body cap + JSON Content-Length policy (`http_body_limit.py`); Tier1 sync `record_failure`; Anthropic `tool_result`+text conversion preserved. Tests **1466 passed**. | P3 long-function splits remain optional. |
