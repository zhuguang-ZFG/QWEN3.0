...
> 已被 `docs/ONLINE_DISTRIBUTIONS_CN.md` 取代和扩展。

## 目的

本文件保留了最初受 FreeDomain 启发的计划目标名称。VPS 托管公共服务面的当前权威来源现在是 `docs/ONLINE_DISTRIBUTIONS_CN.md`，涵盖了官方网站、开放平台、聊天界面、FRP 端点、nginx 边缘和服务快照。
...
- DNS、FRP、VPS、nginx、systemd、证书及公共服务面变更应记录在 `docs/ONLINE_DISTRIBUTIONS_CN.md`、`infra/vps/`、`STATUS.md`、`docs/LIMA_MEMORY_CN.md` 和 `progress.md` 中。
