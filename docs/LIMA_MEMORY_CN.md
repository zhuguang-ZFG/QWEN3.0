...
| `docs/archive/strategic-plans-2026-06/PROJECT_OPTIMIZATION_ROADMAP_CN.md` | 历史项目路线图（已归档） |
| `findings.md` | 里程碑证据表 |
...
- `docs/archive/strategic-plans-2026-06/PROJECT_OPTIMIZATION_ROADMAP_CN.md` 为历史项目优化路线图（智能设备转型后，已归档）
